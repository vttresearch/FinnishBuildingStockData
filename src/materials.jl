...
"""
    density(material::Object; mod::Module = Main)
...
"""
function density(material::Object; mod::Module = Main)
    Float64(
...
"""
    specific_heat_capacity(material::Object; mod::Module = Main)
...
The `mod` keyword is used to tweak the Module from which the parameters are read.
"""
function specific_heat_capacity(material::Object; mod::Module = Main)
    Float64(
...
The `mod` keyword is used to tweak the Module from which the parameters are read.
"""
function thermal_conductivity(material::Object; weight::Float64 = 0.5, mod::Module = Main)
