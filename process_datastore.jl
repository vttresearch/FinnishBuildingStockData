...
if length(ARGS) < 2
    ...
    7. variation_period=1209600, "period of variations" as defined in EN ISO 13786:2017 Annex C. Based on the calibrations performed in https://cris.vtt.fi/en/publications/sensitivity-of-a-simple-lumped-capacitance-building-thermal-model, equal to two weeks in seconds.
    """
else
